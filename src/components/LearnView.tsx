...
export default function LearnView() {
  ...
  if (loading) {
    return <div className="h-64 flex items-center justify-center text-slate-500">Loading Academy Profile...</div>;
  }
        ...
        {!selectedSlug ? (
          ...
          >
            ...
            <Card className="border-none shadow-[0_8px_30px_rgb(0,0,0,0.06)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.4)] rounded-[2.5rem] bg-indigo-950 text-white overflow-hidden relative pb-4">
              ...
              <CardContent className="p-8 md:p-12 relative z-10 flex flex-col items-center gap-10">
          ...
          >
            ...
            <div className="max-w-7xl mx-auto mb-8">
              ...
              >
                ...
                <span className="font-bold text-sm tracking-tight text-slate-700 dark:text-slate-300 group-hover:text-indigo-600">Back to Academy Dashboard</span>
              </Button>
            </div>
